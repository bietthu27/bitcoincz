...
public:
    ...
    int MaxCheckblocks() const { return nMaxCheckblocks; }
    int64_t MaxClockdrift() const { return nMaxClockdrift; }
    int64_t StakeMinAge() const { return nStakeMinAge; }
    int64_t StakeTargetSpacing() const { return nStakeTargetSpacing; }
    const uint256& powLimit() const { return npowLimit; }
    /** Used if GenerateBCZ is called with a negative number of threads */
    ...
    /** Zerocoin **/
    libzerocoin::ZerocoinParams* Zerocoin_Params(bool notused) const;
