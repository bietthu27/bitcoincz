...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"bczprivkey\" ( \"label\" rescan )\n"
...
UniValue reveal_wallet_keys(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("reveal_wallet_keys", "\"test\"") + HelpExampleRpc("reveal_wallet_keys", "\"test\""));
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("bip38encrypt", "\"BMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\" \"mypasphrase\"") +
            HelpExampleRpc("bip38encrypt", "\"BMJRSsuU9zfyrvxVaAEFQqK4MxZg6vgeS6\" \"mypasphrase\""));
