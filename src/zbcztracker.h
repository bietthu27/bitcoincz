...
#ifndef BITCOIN_ZBCZTRACKER_H
#define BITCOIN_ZBCZTRACKER_H
...
public:
    CzBCZTracker(std::string strWalletFile);
    ~CzBCZTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBCZWallet* zBCZWallet = NULL);
