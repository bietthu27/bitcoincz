...
bool CMasternodeSync::IsBlockchainSynced()
{
    ...
    // if the last call to this function was more than 180 minutes ago (client was in sleep mode) reset the sync process
    if (GetTime() - lastProcess > Params().MaxClockdrift()) {
        Reset();
    ...
    if (pindex->nTime + Params().MaxClockdrift() < GetTime())
        return false;
