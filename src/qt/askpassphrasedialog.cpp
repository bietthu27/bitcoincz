                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zBCZ || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending BCZ because you wouldn't check it anyway.
    if (context == Context::Send_BCZ || context == Context::Send_zBCZ) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BCZ</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("BCZ will close now to finish the encryption process. "
                               ...
                               "your BCZs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
