...
private:
    ...
    int nDisplayUnit;
    void getPercentage(CAmount nTotalBalance, CAmount nZerocoinBalance, QString& sBCZPercentage, QString& szBCZPercentage);
...
private slots:
    ...
    void updateWatchOnlyLabels(bool fshowWatchOnly);
