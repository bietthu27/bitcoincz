...
std::string ReindexZerocoinDB()
{
    ...
    while (pindex) {
        uiInterface.ShowProgress(_("Reindexing zerocoin database..."), std::max(1, std::min(99, (int)((double)(pindex->nHeight - zerostart) / (double)(chainActive.Height() - zerostart) * 100))));
