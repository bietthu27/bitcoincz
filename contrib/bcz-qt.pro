...
RESOURCES += src/qt/bcz.qrc src/qt/bcz_locale.qrc

TRANSLATIONS += src/qt/locale/bcz_bg.ts \
                src/qt/locale/bcz_de.ts \
                src/qt/locale/bcz_en.ts \
                src/qt/locale/bcz_es.ts \
                src/qt/locale/bcz_fi.ts \
                src/qt/locale/bcz_fr.ts \
                src/qt/locale/bcz_it.ts \
                src/qt/locale/bcz_ja.ts \
                src/qt/locale/bcz_pl.ts \
                src/qt/locale/bcz_pt.ts \
                src/qt/locale/bcz_ru.ts \
                src/qt/locale/bcz_sk.ts \
                src/qt/locale/bcz_sv.ts \
                src/qt/locale/bcz_vi.ts \
                src/qt/locale/bcz_zh_CN.ts \
                src/qt/locale/bcz_zh_TW.ts
