...
This means one can have an always-on bczd instance running, and another local bczd/bcz-qt instance which connects to this node and receives blocks from it.
