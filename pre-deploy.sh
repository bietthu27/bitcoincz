...
cp $TRAVIS_BUILD_DIR/src/qt/bcz-qt $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/qt/bcz-qt.exe $OUTDIR/bin/ || echo "no QT Wallet"
cp $TRAVIS_BUILD_DIR/src/bczd $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/bczd.exe $OUTDIR/bin/ || echo "no D"
cp $TRAVIS_BUILD_DIR/src/bcz-cli $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/bcz-cli.exe $OUTDIR/bin/ || echo "no CLI"
cp $TRAVIS_BUILD_DIR/src/bcz-tx $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/bcz-tx.exe $OUTDIR/bin/ || echo "no TX"
