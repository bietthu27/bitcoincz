...
#   c) node1 mines 32 blocks, so now node 0 has 60001bcz, node 1 has 4250bcz, node2 has none.
#   d) node0 sends 601 bcz to node2, in two transactions (301 bcz, then 300 bcz).
